...
; CHECK:	mov.w	disp+2(r0), r15         ; encoding: [0x1f,0x40,A,A]
; CHECK:                                        ;   fixup A - offset: 2, value: disp+2, kind: fixup_16_pcrel_byte
; CHECK:	mov.w	disp+2(r2), r15         ; encoding: [0x1f,0x42,A,A]
...
; CHECK:	mov.w	disp(r0), disp+2(r0)    ; encoding: [0x90,0x40,A,A,B,B]
